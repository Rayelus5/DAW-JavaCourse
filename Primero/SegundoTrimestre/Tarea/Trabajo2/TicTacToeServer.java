...
public class TicTacToeServer {
    ...
    protected JLabel lblNewLabel_title;
    ...
    public static void player_2_win(){
        JOptionPane.showMessageDialog(null, "Your Lose The Match");
        p2++;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    TicTacToeServer window = new TicTacToeServer();
        ...
        try {
            ...
            lblNewLabel_1_connected.setVisible(true);
            lblNewLabel_1_connected.setText("Client is no longer connected");
        }
    ...
    protected void initialize()  {
        ...
        btnNewButton_1.setBounds(90, 88, 138, 92);
        ...
        btnNewButton_2.setBounds(228, 88, 122, 92);
        ...
        btnNewButton_3.setBounds(350, 88, 122, 92);
        ...
        btnNewButton_4.setBounds(90, 180, 138, 92);
        ...
        btnNewButton_5.setBounds(228, 180, 122, 92);
        ...
        btnNewButton_6.setBounds(350, 180, 122, 92);
        ...
        lblNewLabel_score2.setBounds(238, 519, 138, 41);
        ...
        lblNewLabel_title.setBounds(114, 11, 324, 66);
        ...
        lblNewLabel.setBounds(482, 90, 81, 274);
        frame.getContentPane().add(lblNewLabel);

        lblNewLabel_1_connected = new JLabel("");
        lblNewLabel_1_connected.setFont(new Font("Tahoma", Font.PLAIN, 30));
        lblNewLabel_1_connected.setForeground(Color.RED);
        lblNewLabel_1_connected.setBounds(90, 375, 470, 55);
